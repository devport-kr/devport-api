...
class CacheInvalidationIntegrationTest {
    ...
    void articleScope_invalidation_clearsArticleCaches() {
        ...
        String articleListKey = CacheKeyFactory.articleListKey("AI_LLM", 0, 20);
    ...
    void unknownScope_invalidation_clearsAllCriticalCaches() {
        ...
        String articleKey = CacheKeyFactory.articleListKey("AI_LLM", 0, 20);
    ...
    void differentKeyDimensions_createSeparateEntries_noCollision() {
        ...
        String keyCategory1 = CacheKeyFactory.articleListKey("AI_LLM", 0, 20);
        String keyCategory2 = CacheKeyFactory.articleListKey("FRONTEND", 0, 20);
